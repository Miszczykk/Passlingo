...
abstract class BaseDialogAction<State, DialogState>(
    protected val uiStateFlow: MutableStateFlow<State>, protected val externalScope: CoroutineScope
) {
        ...
        externalScope.launch {
            runCatching {
                ...
                uiStateFlow.update { state ->
                    updateStateWithDialog(
                        state, dialogState = createErrorDialogState(
